...
test_1.1 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(default_logistic_student$residuals) * 10e10)), 
                 "c266b574ba6bffbb207c49bcb02af927")
  })
...
test_1.9 <- function() {
  ...
  answer_as_numeric <- as.numeric(answer1.9)
...
test_1.10 <- function() {
  ...
  answer_as_numeric <- as.numeric(answer1.10)
  test_that("Solution should be a number", {
    expect_false(is.na(answer_as_numeric))
  })
...
test_1.12 <- function() {
    check_MC(answer1.12, getPermutations(LETTERS[1:6]), 'ec8a0a5a3680bfac4d17f8072e092200')
}
...
test_1.14 <- function() {
    check_MC(answer1.14, getPermutations(LETTERS[1:5]), '93e311a221d93a15962a246827baabdc')
}
