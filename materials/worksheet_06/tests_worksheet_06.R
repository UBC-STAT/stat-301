...
test_1.2.1 <- function() {
  check_DF(my_gof,
           c('RSS', 'TSS', 'R2', 'adjR2', 'RSE'),
           "4b5630ee914e848e8d07221556b0a2fb",
           c('RSS', 'TSS', 'R2', 'adjR2', 'RSE'),
           c(1e12, 1e12, 1e8, 1e8, 1e8),
           c("0913dc6482458390515487fa6f4ff78a",
             "4812c47e4e1c83ee9089891b5a49a689",
             "a3a8a537b48867f89efbd8bab03980ce",
             "2e95fcfc4c4836251aed6b9364555e39",
             "2dcf2c54156bea4c4f3260a4b63469f3"
           ))
}
