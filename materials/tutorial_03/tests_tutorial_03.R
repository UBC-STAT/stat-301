...
test_1.3 <- function() {
    check_DF(corr_matrix_CASchools,
            ...
            "754bc61780613e9dbb928b88e1e3d6f5",
             c("corr"),
             c(10000),
             c("fbbcd2eceadb3e16dc59afd7ced2c262"))
}
...
test_1.5 <- function() {
    check_DF(MLR_CASchools_results,
            c("term", "estimate",  "std.error", "statistic", "p.value"),  
             ...
             c(100, 100, 100,   1),
             c("6a6dde93dbd2d9795e806ae4feb3801f",
               "9f1dae3619860a497fda8a269d91e70b",
               "7e9fd05482b3c504ee58151442149256",
...
test_1.8 <- function() {
    check_DF(red_MLR_CASchools_results,
            c("term", "estimate",  "std.error", "statistic", "p.value"),  
             ...
             c("estimate",  "std.error", "statistic", "p.value"),  
             c(100, 100, 100,   1),
             c("24a10e92012566f21ed37e95992029ef",
...
test_2.3 <- function() {
  ...
  check_numeric(N_athletes, 1,"13dff35616f15788a3612d24ae7e23c5")
}
...
test_2.5 <- function() {
  check_DF(sample_TikTok,
           c("athlete","y_current_ad","y_new_ad","x_self_choice","y_obs"),
           "b6a6227038bf9be67533a45a6511cc7e",
           c("y_obs" ),
           c(1e4),
           c("8b20b9383d5077c07873c905568e6e15"))
}
...
test_2.11 <- function() {
  check_DF(sample_TikTok,
           c("athlete", "y_current_ad", "y_new_ad", "x_self_choice", "y_obs", "x_randomized", "y_exp"),
           "b6a6227038bf9be67533a45a6511cc7e",
           c("y_exp"),
           c(1e4),
           c("6dccddbe3801968a2e88fa043b6209cc")
  )
}
# -
...
test_2.13 <- function() {
  check_DF(exp_study_TikTok_results,
           ...
           c("estimate",  "std.error", "statistic", "p.value",   "conf.low" , "conf.high"),
           c(100, 100, 100,   1, 100, 100),
           c("6aa5567705b017d5b51b219fa8088225",
             "5e9df39bb0ad592a23f9d09fd6673704",
             "8c6f32832d2880b5f832b7a1c8910ca6",
             "1473d70e5646a26de3c52aa1abd85b1f",
             "e2788cda4d62bca9ae046ad02d95181e",
             "f215530efbfe20021fad3556ffc7a4a3"))
}
