...
# Question 1.1
test_1.1 <- function() {
    check_MC(answer1.1, LETTERS[1:2], '127a2ec00989b9f7faf671ed470be7f8')
}
...
# Question 1.2
test_1.2.0 <- function() {
    check_MC(answer1.2.0, c('total_engagement_percentage',
                            "page_engagement_percentage"),
             '43f33097b14c863532a59c4455ce0920')
}

test_1.2.1 <- function() {
    check_MC(answer1.2.1, c('total_engagement_percentage',
...
test_2.0 <- function() {
    check_TF(answer2.0, '05ca18b596514af73f6880309a21b5dd')
}
...
test_2.2 <- function() {
    check_MC(answer2.2, LETTERS[1:3], 'ddf100612805359cd81fdc5ce3b9fbba')
}
...
test_2.3 <- function() {
    check_MC(answer2.3, LETTERS[1:4], '6e7a8c1c098e8817e3df3fd1b21149d1')
}
