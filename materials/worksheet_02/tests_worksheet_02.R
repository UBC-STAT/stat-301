...
test_1.3 <- function() {
    check_MC(answer1.3, LETTERS[1:6], '7279bb4184f9c53d42729c6eb22db36a')
}
...
test_1.4 <- function() {
    check_MC(answer1.4, LETTERS[1:3], '6e7a8c1c098e8817e3df3fd1b21149d1')
}
...
test_1.5 <- function() {
    check_MC(answer1.5, LETTERS[1:3],'127a2ec00989b9f7faf671ed470be7f8')
}
