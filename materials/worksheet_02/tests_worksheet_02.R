...
test_1.2.0 <- function() {
  test_that('Did not assign answer to an object called "answer1.2.0"', {
    expect_true(exists("answer1.2.0"))
  })
  
  test_that('Solution should be a single character ("A", "B", "C", or "D")', {
    expect_match(answer1.2.0, "a|b|c|d", ignore.case = TRUE)
  })
  
  answer_hash <- digest(tolower(answer1.2.0))
...
test_1.2.1 <- function() {
  ...
  test_that('Solution should be a single character ("A", "B", or "C")', {
    expect_match(answer1.2.1, "a|b|c", ignore.case = TRUE)
  })
...
test_1.2.2 <- function() {
  test_that('Did not assign answer to an object called "answer1.2.2"', {
    expect_true(exists("answer1.2.2"))
  })
  
  test_that('Solution should be "true" or "false"', {
    expect_match(answer1.2.2, "true|false", ignore.case = TRUE)
  })
  
  answer_hash <- digest(tolower(answer1.2.2))
  #if (answer_hash == "") {
  #  print("HINT_HERE")
  #}
...
test_2.3.0 <- function() {
  test_that('Did not assign answer to an object called "answer2.3.0"', {
    expect_true(exists("answer2.3.0"))
  })

  test_that('Solution should be a single character ("A", "B", or, "C")', {
    expect_match(answer2.3.0, "a|b|c", ignore.case = TRUE)
  })

  answer_hash <- digest(tolower(answer2.3.0))
  test_that("Solution is incorrect", {
...
test_2.3.1 <- function() {
  test_that('Did not assign answer to an object called "answer2.3.1"', {
    expect_true(exists("answer2.3.1"))
  })
  
  test_that("answer2.3.1 should be a data frame", {
    expect_true("data.frame" %in% class(answer2.3.1))
  })
  
  test_that("answer2.3.1 does not contain the correct data", {
    #expect_equal(digest(as.integer(sum(answer2.3.1$p_value) * 1e5)), "634bb5b4ea8305f2b5a4fb11f6c23555")
    expect_equal(digest(as.integer(sum(answer2.3.1$p_value) * 1e5)), "4c9b31fb1bead98ab279175cc58f6237")
...
test_2.3.3 <- function() {
  ...
  test_that('Solution should be a single character ("A", "B", "C")', {
    expect_match(answer2.3.3, "a|b|c", ignore.case = TRUE)
  })
  
  answer_hash <- digest(tolower(answer2.3.3))
  test_that("Solution is incorrect", {
    expect_equal(answer_hash, "ddf100612805359cd81fdc5ce3b9fbba")
  })
...
test_2.3.4 <- function() {
  ...
  test_that('Solution should be a single character ("A", "B", "C")', {
    expect_match(answer2.3.4, "a|b|c", ignore.case = TRUE)
  })
  
  answer_hash <- digest(tolower(answer2.3.4))
  test_that("Solution is incorrect", {
    expect_equal(answer_hash, "ddf100612805359cd81fdc5ce3b9fbba")
  })
...
test_2.3.5 <- function() {
  ...
  test_that("Solution should be a data frame", {
    expect_true("data.frame" %in% class(answer2.3.5))
  })

  expected_colnames <- c("n_rejections", "expected_n_rejections")
  given_colnames <- colnames(answer2.3.5)
  ...
  test_that("Data frame does not contain the correct number of rows", {
    expect_equal(digest(as.integer(nrow(answer2.3.5))), "4b5630ee914e848e8d07221556b0a2fb")
  })

  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(answer2.3.5$n_rejections) * 1e3)), "5564fa9c839a49eac3525e6f8c15faf3")
  })
...
test_2.3.6 <- function() {
  test_that('Did not assign answer to an object called "answer2.3.6"', {
    expect_true(exists("answer2.3.6"))
  })

  test_that('Solution should be a single character ("A", "B", "C", "D", "E")', {
    expect_match(answer2.3.6, "a|b|c|d|e", ignore.case = TRUE)
  })

  answer_hash <- digest(tolower(answer2.3.6))
