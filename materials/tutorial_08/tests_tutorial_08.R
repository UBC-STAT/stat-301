...
test_1.0 <- function() {
  test_that('Did not assign answer to an object called "model_matrix_X_train"', {
    expect_true(exists("matrix_X_train"))
  })

  test_that("Solution should be a matrix", {
    expect_true("matrix" %in% class(matrix_X_train))
  })
  test_that("Solution should be a matrix", {
  ...
  given_colnames <- colnames(matrix_X_train)
  ...
  test_that("Matrix does not contain the correct number of rows", {
    expect_equal(digest(as.integer(nrow(matrix_X_train))), "e1ccdeeda146ea6a2b9098eac7f58ac2")
  })
  test_that("Matrix does not contain the correct number of rows", {
  ...
  test_that("Matrix does not contain the correct data", {
    expect_equal(digest(as.integer(sum(matrix_X_train[,"mean_radius"]) * 10e4)), "da0c890b39f1f7a79777df921f405a41")
  })
  test_that("Matrix does not contain the correct data", {
