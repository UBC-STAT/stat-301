...
test_1.0 <- function() {
  check_numeric_element(sum(concrete_cv_lambda_ridge$lambda),
                        1e2,
...
test_1.1 <- function() {
  check_numeric_element(sum(concrete_cv_lambda_ridge$lambda) - sum(plot_data$lambda),
                        1e4,
...
test_1.2 <- function() {
  check_numeric(concrete_lambda_min_MSE_ridge,
                1e4,
...
test_1.3 <- function() {
  check_numeric_element(sum(concrete_ridge_min_coef),
                        1e3,
                        "545a59cd8c32824cf26c84e248a96407")
}
...
test_1.4 <- function() {
  check_DF(concrete_coefs,
            c("Full_OLS", "Ridge_min"),
            "8eaca7c9b35d05ab15c9125bc92372fa",
            c("Full_OLS", "Ridge_min"),
            c(10000, 10000),
            c("0aee6a6c4ffd1222be5710c524ee3009", "6db04c042aba736caee025c6afd40a11"))
}
...
test_1.5 <- function() {
  check_numeric_element(sum(concrete_test_pred_full_OLS),1e4,"0f368293ccdf2e068f18935bfb7271cd")
}

# Question 1.6

test_1.6 <- function() {
  check_DF(concrete_test_RMSEs,
           c("Model","RMSE"),
           "4b5630ee914e848e8d07221556b0a2fb",
           "RMSE",
           1e+06,
           "199942a6408be98d65552dca36ed49e3")
}
...
test_1.7 <- function() {
  check_numeric_element(sum(concrete_test_pred_ridge_min),
                        1e2,
                        "945e63d42d44e0a583e5a55a3a48917b")
}
...
test_1.8 <- function() {
  check_DF(concrete_test_RMSEs,
            ...
            "RMSE",
            1e+06,
            "7c2de6985c0df5263503b4044393c415")
}
