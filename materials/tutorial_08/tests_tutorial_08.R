...
test_2.1 <- function() {
    check_numeric_element(sum(fat_full_OLS_add$coefficients),1e4,"45fdb468aa4f799a79f6344a5ba2400d")
}
# -
...
test_2.4 <- function() {
    check_DF(fat_fwd_summary_df,
             c("RSQ", "RSS", "ADJ.R2", "BIC"),
             "06cd248dd1409b804444bd9ad5533d1d",
             c("RSQ", "RSS", "ADJ.R2", "BIC"),
             c(1000, 1000, 1000, 1000),
             c("b4deab2ff8168b74b45443cd372cc207", "2344494dccc2f1d97ae1b687f9c1848e", 
               "782bab1ecf9b61f18af42f69d4cdddfe", "a1fee7f9c4ee005b7800a88af6c1fe9e"))
}
...
test_2.5 <- function() {
    check_DF(fat_forward_sel_candidate_models,
             c("n_input_variables", "C_p"),
             "06cd248dd1409b804444bd9ad5533d1d",
             c("n_input_variables", "C_p"),
             c(1, 1e+06),
             c("a7f7cec46d9e1398c6bb0b72351f3eab", "c5526a9c0d9889f6e9f2259759169636"))
}
...
test_2.6 <- function() {
    check_MC(answer2.6, LETTERS[1:14], "c733ca3274f47b25d5f66415bfd4261f")
}
...
test_2.7 <- function() {
    check_numeric_element(sum(fat_red_OLS_add$coefficients),1e4,"e5fd00b24472cc93d5b1546344046260")
}
...
test_2.8 <- function() {
    check_numeric_element(sum(fat_test_pred_red_OLS_add),1e4,"d13084c3518721747179f0bd6d8eb3da")
}
...
test_3.0 <- function() {
    check_numeric_element(sum(fat_cv_lambda_ridge$lambda),
                         1e4,
                         "c7f66da1cae4f223b9bae717f05900f7")
}
...
test_3.6 <- function() {
 ...
 "R_MSE",
 1e+06,
 "4d496ea91edbe1cfec834e8caf1889e4")
}
