...
test_1.7 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(breast_cancer_AUC_models$auc) * 10e6)), "fc8f762eaa393aedbf5a35b46160056b")
  })
...
test_1.12 <- function() {
  ...
  test_that('Solution should be a single character ("A", "B", "C", or "D")', {
    expect_match(answer1.12, "a|b|c|d", ignore.case = TRUE)
  })
...
test_1.13 <- function() {
  ...
  test_that("Data frame does not contain the correct data", {
    expect_equal(digest(as.integer(sum(breast_cancer_AUC_models$auc) * 10e6)), "1c874c2f64e3ff5d0480656c3dd4714b")
  })
