...
test_2.0 <- function() {
    check_DF(Housing_R_MSE_models,
            c("Model","R_MSE"),
             "4b5630ee914e848e8d07221556b0a2fb",
             c("R_MSE"),
             c("100"),
             c("54f423c03a3738238d20948e7e28cc9c"))
}
...
test_2.1 <- function() {
    check_DF_overflow(housing_back_summary_df,
                     c("RSQ", "RSS", "ADJ.R2", "BIC"),
                      "e6e598642c5fbbfb7d922dbfcec86ed8",
                      c("RSQ", "RSS", "ADJ.R2", "BIC"),
                      c(10000, 10000, 10000, 10000),
                      c("64ebd3dc9199e44d1667ff5c737a304e", "1f5faaf8ed9443a1af14df1bc3d1c873", 
                        "ca5cb6401946ec1c642ab188269da69b", "1a12dae3de523ef3352e70063f130ce7"))
}
...
test_2.2 <- function() {
    check_DF(Housing_backward_sel_candidate_models,
            c("n_input_variables", "C_p"),
 "e6e598642c5fbbfb7d922dbfcec86ed8",
 c("n_input_variables", "C_p"),
 c(1, 1e+05),
 c("525d73b4c5528794642ceb4dd9f987c2", "90cb398978a141c899270814c645dfeb"))
}
...
test_2.3 <- function() {
    check_DF(Housing_R_MSE_models,
             ...
             c("R_MSE"),
             c(100),
             c("7362c5c5ef13476f3099a3ad7637f000")
    )
}
